...
public class CryptLib {
    ...
    private byte[] encryptDecrypt(String inputText, String encryptionKey,
                                  EncryptMode mode, String initVector) throws Exception{
    ...
    String encryptPlainText(String plainText, String key, String iv) throws Exception {
        byte[] bytes = encryptDecrypt(plainText, CryptLib.SHA256(key, 16),
                CryptLib.EncryptMode.ENCRYPT, iv);
        return android.util.Base64.encodeToString(bytes, android.util.Base64.DEFAULT);
    }

    String decryptCipherText(String cipherText, String key, String iv) throws Exception {
        byte[] bytes = encryptDecrypt(cipherText, CryptLib.SHA256(key, 16),
                CryptLib.EncryptMode.DECRYPT, iv);
